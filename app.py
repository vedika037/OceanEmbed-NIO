...
:root{--accent:#238edb;--text:#172532;--muted:#536b7b;--line:#263b4a;--panel:#dce8ef;--panel2:#cbdce7;--green:#238b70;--amber:#b47a00;--red:#c94f6b;--lav:#596fc4}
...
.status{font-size:.72rem;font-weight:700;color:#176a55;background:#c8e6dc;border:1px solid var(--line);border-radius:20px;padding:5px 10px}
...
.warning{background:#f1e4c5;border:1px solid var(--line);border-left:4px solid #b47a00;border-radius:5px;padding:10px 12px;color:#654900;font-size:.8rem}
.good{background:#d1e9e1;border:1px solid var(--line);border-left:4px solid #238b70;border-radius:5px;padding:10px 12px;color:#185b49;font-size:.8rem}
...
[data-testid="stMetric"]{background:#dce8ef;border:1px solid var(--line);padding:10px 12px;border-radius:7px}
